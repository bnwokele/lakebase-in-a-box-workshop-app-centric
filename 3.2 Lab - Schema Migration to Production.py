...
# MAGIC %md
# MAGIC # Lab 3.2: Schema Changes — Feature Branch to Production
# MAGIC
# MAGIC In Lab 3.1, we created a feature branch `dev-loyalty-reviews`, added the `loyalty_points` column to the `customers` table, created new `loyalty_members` and `reviews` tables. Now we'll promote those changes to production using the **Migration Replay** pattern.
# MAGIC
...
# MAGIC
# MAGIC **Next:** In Lab 3.3, we'll explore **Branch Reset** hands-on, and in Lab 4.1, **Point-in-Time Recovery**.
