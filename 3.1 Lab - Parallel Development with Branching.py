...
# MAGIC %md
# MAGIC # Lab 3.1: Parallel Development with Branching
# MAGIC
# MAGIC ---
# MAGIC
# MAGIC This lab introduces **Lakebase Autoscaling Branching** — a key feature that brings the agility of code branching (branches, PRs, CI/CD) to your database. You'll learn the concepts behind branching and then apply them hands-on by simulating three developers working in parallel on isolated branches.
# MAGIC
...
# MAGIC will be promoted to production along with the loyalty features in Lab 3.2 — giving
...
# MAGIC
# MAGIC **Next:** In Lab 3.2, we'll promote Developer A's changes to production using the **Migration Replay** pattern, and explore the **Schema Diff** tool.
