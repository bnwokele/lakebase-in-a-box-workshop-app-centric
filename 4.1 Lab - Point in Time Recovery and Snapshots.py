...
# MAGIC %md
# MAGIC # Lab 4: Point-in-Time Recovery (PITR) & Snapshots
# MAGIC
# MAGIC ---
# MAGIC
# MAGIC This lab covers two key data protection features of Lakebase: **Point-in-Time Recovery (PITR)** and **Snapshots**. You'll learn the concepts behind each, then apply PITR hands-on by simulating a production disaster and recovering from it.
# MAGIC
...
# MAGIC Lab 3.2 — idempotent DDL that's safe to run multiple times.
# MAGIC
