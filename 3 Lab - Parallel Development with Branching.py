...
# MAGIC > which is what **Lab 4** does. The storefront won't light up loyalty/reviews until then.
...
# MAGIC will be promoted to production along with the loyalty features in Lab 4 — giving
...
# MAGIC
# MAGIC **Next:** In Lab 4, we'll promote Developer A's changes to production using the **Migration Replay** pattern, and explore the **Schema Diff** tool.
