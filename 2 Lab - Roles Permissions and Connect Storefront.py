...
# MAGIC > and new tables are created (reviews in Lab 4, promotions in Lab 6), the SP
...
# MAGIC
# MAGIC If you've already created branches in Lab 3, the SP needs roles on those too.
...
# if granted_count == 0:
#     print("ℹ️ No dev branches found (only production). This is expected before Lab 3.")
# else:
...
# MAGIC
# MAGIC - **Lab 3** — Parallel development on isolated branches (no storefront change)
