...
# MAGIC %md
# MAGIC # Lab 5: Reverse ETL — Serving Lakehouse Data to Applications
# MAGIC
# MAGIC ---
# MAGIC
# MAGIC This lab covers **Reverse ETL** — the process of moving curated analytics data from the Databricks Lakehouse into Lakebase Postgres, making it available to low-latency applications. You'll learn the concepts behind Reverse ETL and Synced Tables, then apply them hands-on by syncing Spring Sale promotions to the DataCart Storefront.
# MAGIC
