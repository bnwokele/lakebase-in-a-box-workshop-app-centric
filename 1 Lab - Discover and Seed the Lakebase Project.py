...
# MAGIC metadata — the same metadata your analytics tooling will see.
# MAGIC
...
# MAGIC
# MAGIC It's worth seeing now so you know the data is already accumulating.
...
# MAGIC **Lakehouse Sync**, **branching**, and **schema migration**.
